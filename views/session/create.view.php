...
<main>
	<div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
		...
		<h2 class="text-2xl font-bold text-center mb-6">Log In now</h2>
	
		<form method="POST" action="/login" class="max-w-lg mx-auto ">
			<div class="space-y-12 flex justify-center">
				<div class="border-b border-gray-900/10 pb-12 w-full">
					...
					<div >
						...
						<div class="mt-2">
							<input required type="email" id="email" name="email" class="w-full block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="<?= old('email') ?>" />
